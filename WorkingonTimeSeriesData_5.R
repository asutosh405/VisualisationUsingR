...
#let's start working on a new data set called "economics" which contains US economic data.
#This data set is different from the previous three because the data in the "economics" 
#data set is time dependent, i.e. it contains time series data.
...
# Note the steep dip at 2008 - That is the infamous recession
...
# Check structure of recent data frame
