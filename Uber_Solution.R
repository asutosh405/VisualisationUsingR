setwd("C:\\Asutosh\\PGDDA\\Analytics\\Fidelity_Training\\R-viz\\UberCaseStudy")
dataset<- Uber.request.data <- read.csv("Uber request data.csv")

library(stringr)
# about the stringr package. package for character manipulation.
